      ...
      <>
          <Router>
            ...
            <Routes>
              ...
              <Route path="/api/generalchat" element={this.state.auth ? (<GeneralChat generalChat={this.getGeneralChat} user_id={this.state.user_id} comments={this.state.comments}/>) : (<Navigate replace to = {"/"} />)} />
